...
type History struct {
	...
	PersonaID   string    `gorm:"column:persona_id;type:uuid;not null" json:"personaId"`
	TransformID string    `gorm:"column:transform_id;type:uuid;not null" json:"transformId"`
	CreatedAt   time.Time `json:"createdAt"`

	Persona   Persona   `gorm:"foreignKey:PersonaID" json:"persona,omitempty"`
	Transform Transform `gorm:"foreignKey:TransformID" json:"transform,omitempty"`
}
